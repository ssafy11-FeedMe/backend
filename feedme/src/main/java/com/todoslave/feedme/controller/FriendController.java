...
public class FriendController {
    ...
    // 친구 추가하기
    @PostMapping
    public ResponseEntity<Void> addFriend(@RequestParam("counterEmail") String email){
    ...
    // 친구 삭제하기
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> removeFriend(@RequestParam("id") String friendId){
    ...
    // 친구 목록 불러오기
    @GetMapping
    public ResponseEntity<List<Friend>> findFriends(){
        //token으로부터 memberId를 찾는 로직
        int memberId;
